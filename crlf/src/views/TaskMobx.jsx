...
// @observer //if class component
// @inject('task', 'personal') //if class component
const Task = function (props) {
        ...
        return (
          <>
            <Popconfirm
              ...
              onConfirm={handleRemove.bind(this, id)}
            >
              <Button type="link">Delete</Button>
            </Popconfirm>
            {+state !== 2 ? (
              <Popconfirm
                title="Sure to set to Done?"
                onConfirm={handleUpdate.bind(this, id)}
              >
  ...
  const submit = async () => {
    try {
      ...
      let { task: taskText, time } = formIns.current.getFieldValue();
      ...
      >
        ...
        >
          <Form.Item
            label="Task Name"
            name="task"
            rules={[{ required: true, message: "Need input" }, { min: 6 }]}
          >
